...
const CODE_MASK = [0, 0x0001, 0x0003, 0x0007, 0x000f, 0x001f, 0x003f, 0x007f, 0x00ff, 0x01ff, 0x03ff, 0x07ff, 0x0fff]
...
export class LzwReader {
	...
	private badCodeCount: number = 0
	private linesLeft: number = 0
