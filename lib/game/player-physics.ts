...
export class PlayerPhysics {
	...
	public init() {
		...
		this.gravity.x = 0
		this.gravity.y =
			Math.sin(degToRad(slope)) * (this.table.data!.overridePhysics ? DEFAULT_TABLE_GRAVITY : this.table.data!.gravity)
		this.gravity.z =
			-Math.cos(degToRad(slope)) * (this.table.data!.overridePhysics ? DEFAULT_TABLE_GRAVITY : this.table.data!.gravity)
