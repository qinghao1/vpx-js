...
export class KickerHit extends HitCircle {
	...
	private doChangeBallVelocity(ball: Ball, hitNormal: Vertex3D): void {
		...
		if (idx !== 3435973836) {
			...
			const tangent = surfVel.clone(true).subAndRelease(
				// calc the tangential velocity
